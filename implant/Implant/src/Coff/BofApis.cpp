...
BEACON_API InternalFunctions[30] = {
    { (CHAR*)"BeaconDataParse", (PVOID)BeaconDataParse },
    { (CHAR*)"BeaconDataInt", (PVOID)BeaconDataInt },
    { (CHAR*)"BeaconDataShort", (PVOID)BeaconDataShort },
    { (CHAR*)"BeaconDataLength", (PVOID)BeaconDataLength },
    { (CHAR*)"BeaconDataExtract", (PVOID)BeaconDataExtract },
    { (CHAR*)"BeaconFormatAlloc", (PVOID)BeaconFormatAlloc },
    { (CHAR*)"BeaconFormatReset", (PVOID)BeaconFormatReset },
    { (CHAR*)"BeaconFormatFree", (PVOID)BeaconFormatFree },
    { (CHAR*)"BeaconFormatAppend", (PVOID)BeaconFormatAppend },
    { (CHAR*)"BeaconFormatPrintf", (PVOID)BeaconFormatPrintf },
    { (CHAR*)"BeaconFormatToString", (PVOID)BeaconFormatToString },
    { (CHAR*)"BeaconFormatInt", (PVOID)BeaconFormatInt },
    { (CHAR*)"BeaconPrintf", (PVOID)BeaconPrintf },
    { (CHAR*)"BeaconOutput", (PVOID)BeaconOutput },
    { (CHAR*)"BeaconUseToken", (PVOID)BeaconUseToken },
    { (CHAR*)"BeaconRevertToken", (PVOID)BeaconRevertToken },
    { (CHAR*)"BeaconIsAdmin", (PVOID)BeaconIsAdmin },
    { (CHAR*)"BeaconGetSpawnTo", (PVOID)BeaconGetSpawnTo },
    { (CHAR*)"BeaconSpawnTemporaryProcess", (PVOID)BeaconSpawnTemporaryProcess },
    { (CHAR*)"BeaconInjectProcess", (PVOID)BeaconInjectProcess },
    { (CHAR*)"BeaconInjectTemporaryProcess", (PVOID)BeaconInjectTemporaryProcess },
    { (CHAR*)"BeaconCleanupProcess", (PVOID)BeaconCleanupProcess },
    { (CHAR*)"toWideChar", (PVOID)toWideChar },
    { (CHAR*)"LoadLibraryA", (PVOID)LoadLibraryA },
    { (CHAR*)"GetProcAddress", (PVOID)GetProcAddress },
    { (CHAR*)"GetModuleHandleA", (PVOID)GetModuleHandleA },
    { (CHAR*)"FreeLibrary", (PVOID)FreeLibrary },
    { (CHAR*)"__C_specific_handler", (PVOID)NULL } };
