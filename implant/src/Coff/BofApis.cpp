...
/* Data Parsing */
BEACON_API InternalFunctions[30] = {
    { .Name = (CHAR*)"BeaconDataParse", .Address = (PVOID)BeaconDataParse },
    { .Name = (CHAR*)"BeaconDataInt", .Address = (PVOID)BeaconDataInt },
    { .Name = (CHAR*)"BeaconDataShort", .Address = (PVOID)BeaconDataShort },
    { .Name = (CHAR*)"BeaconDataLength", .Address = (PVOID)BeaconDataLength },
    { .Name = (CHAR*)"BeaconDataExtract", .Address = (PVOID)BeaconDataExtract },
    { .Name = (CHAR*)"BeaconFormatAlloc", .Address = (PVOID)BeaconFormatAlloc },
    { .Name = (CHAR*)"BeaconFormatReset", .Address = (PVOID)BeaconFormatReset },
    { .Name = (CHAR*)"BeaconFormatFree", .Address = (PVOID)BeaconFormatFree },
    { .Name = (CHAR*)"BeaconFormatAppend", .Address = (PVOID)BeaconFormatAppend },
    { .Name = (CHAR*)"BeaconFormatPrintf", .Address = (PVOID)BeaconFormatPrintf },
    { .Name = (CHAR*)"BeaconFormatToString", .Address = (PVOID)BeaconFormatToString },
    { .Name = (CHAR*)"BeaconFormatInt", .Address = (PVOID)BeaconFormatInt },
    { .Name = (CHAR*)"BeaconPrintf", .Address = (PVOID)BeaconPrintf },
    { .Name = (CHAR*)"BeaconOutput", .Address = (PVOID)BeaconOutput },
    { .Name = (CHAR*)"BeaconUseToken", .Address = (PVOID)BeaconUseToken },
    { .Name = (CHAR*)"BeaconRevertToken", .Address = (PVOID)BeaconRevertToken },
    { .Name = (CHAR*)"BeaconIsAdmin", .Address = (PVOID)BeaconIsAdmin },
    { .Name = (CHAR*)"BeaconGetSpawnTo", .Address = (PVOID)BeaconGetSpawnTo },
    { .Name = (CHAR*)"BeaconSpawnTemporaryProcess", .Address = (PVOID)BeaconSpawnTemporaryProcess },
    { .Name = (CHAR*)"BeaconInjectProcess", .Address = (PVOID)BeaconInjectProcess },
    { .Name = (CHAR*)"BeaconInjectTemporaryProcess", .Address = (PVOID)BeaconInjectTemporaryProcess },
    { .Name = (CHAR*)"BeaconCleanupProcess", .Address = (PVOID)BeaconCleanupProcess },
    { .Name = (CHAR*)"toWideChar", .Address = (PVOID)toWideChar },
    { .Name = (CHAR*)"LoadLibraryA", .Address = (PVOID)LoadLibraryA },
    { .Name = (CHAR*)"GetProcAddress", .Address = (PVOID)GetProcAddress },
    { .Name = (CHAR*)"GetModuleHandleA", .Address = (PVOID)GetModuleHandleA },
    { .Name = (CHAR*)"FreeLibrary", .Address = (PVOID)FreeLibrary },
    { .Name = (CHAR*)"__C_specific_handler", .Address = (PVOID)NULL } };
...
BOOL BeaconSpawnTemporaryProcess( BOOL x86, BOOL ignoreToken, STARTUPINFO* sInfo, PROCESS_INFORMATION* pInfo ) {
    ...
    if (x86) {
        bSuccess = CreateProcessA(
            NULL, (char*)"C:\\Windows\\" X86PATH "\\" DEFAULTPROCESSNAME, NULL, NULL, TRUE, CREATE_NO_WINDOW, NULL, NULL, sInfo, pInfo );
    } else {
        bSuccess = CreateProcessA(
            NULL, (char*)"C:\\Windows\\" X64PATH "\\" DEFAULTPROCESSNAME, NULL, NULL, TRUE, CREATE_NO_WINDOW, NULL, NULL, sInfo, pInfo );
    }
    return bSuccess;
}
