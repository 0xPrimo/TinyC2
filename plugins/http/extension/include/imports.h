...
WININET$InternetConnectA(
    HINTERNET hInternet, LPCSTR lpszServerName, INTERNET_PORT nServerPort, LPCSTR lpszUserName,
...
BOOLAPI WININET$HttpAddRequestHeadersA(
...
BOOLAPI WININET$HttpSendRequestA(
    HINTERNET hRequest, LPCSTR lpszHeaders, DWORD dwHeadersLength, LPVOID lpOptional,
    DWORD dwOptionalLength );
#define HttpSendRequestA WININET$HttpSendRequestA

BOOLAPI WININET$InternetReadFile(
